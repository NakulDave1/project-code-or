        ...
        <?php $__currentLoopData = $combinations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $combination): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <?php if(strlen($str) > 0): ?>
                <tr>
                    ...
                    <td>
                        <input type="number" name="qty_<?php echo e($str); ?>" value="<?php echo e($stock); ?>" min="1" max="1000000" step="1" class="form-control" required>
                    </td>
                </tr>
            <?php endif; ?>
...
<?php /**PATH /home/hpsystem/project/project-code/resources/views/backend/product/partials/_sku_combinations.blade.php ENDPATH**/ ?>