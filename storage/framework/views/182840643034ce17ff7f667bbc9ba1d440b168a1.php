    ...
    <div class="main-content app-content mt-0">
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <?php echo $__env->make('layouts._error_notify', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                </div>
                <!-- PAGE-HEADER -->
                <div class="page-header">
                    <h1 class="page-title">
                        <a href="<?php echo e(route('product.index')); ?>" class="btn btn-primary me-2"><i class="fe fe-arrow-left"></i> Go Back</a>
                    </h1>
                    <div>
                        <ol class="breadcrumb">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <form class="new-added-form" action="<?php echo e(route('product.store')); ?>" method="post" enctype="multipart/form-data" id="choice_form">
                                <?php echo csrf_field(); ?>
                                <div class="card-body">
                                    <div class="row mb-4">
                                        <div class="col-6">
                                            <label class="form-label">Name * :</label>
                                            <input type="text" placeholder="Enter name" class="form-control" name="title" value="<?php echo e(old('title')); ?>" id="title">
                                        </div>
                                        <div class="col-6">
                                            <label>Slug *</label>
                                            <input type="text" placeholder="Enter slug" class="form-control" name="slug" value="<?php echo e(old('slug')); ?>" id="slug">
                                        </div>
                                    </div>
                                            ...
                                            <select name="cat_ids" class="form-control form-select select2" data-bs-placeholder="Select Category">
                                                ...
                                                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    ...
                                                    <?php $__currentLoopData = $category->childrenCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $childCategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <?php echo $__env->make('backend.category.child_category', ['child_category' => $childCategory], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <?php if(\App\Models\Attribute::count() > 0): ?>
                                    ...
                                    <div class="row ">
                                        <div class="col-6">
                                            ...
                                            <select  name="colors[]" class="form-control select2 color-var-select" id="colors-selector" multiple >
                                                <?php if(\App\Models\Attribute::where(['has_color'=>1])->count()>0): ?>
                                                    <?php $__currentLoopData = \App\Models\Attribute::where(['has_color'=>1])->first()->attribute_values; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $color): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value=<?php echo e($color->color_code); ?> <?php if(isset($product['colors'])): ?> <?php echo e(in_array($color->color_code,$product['colors'])?'selected':''); ?> <?php endif; ?>><?php echo e($color['name']); ?></option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                <?php endif; ?>
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <select  name="choice_attributes[]" class="form-control select2 color-var-select" id="choice_attributes" multiple >
                                                    <?php $__currentLoopData = \App\Models\Attribute::where('has_color',0)->orderBy('name','ASC')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attribute): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($attribute->id); ?>" ><?php echo e(ucfirst($attribute['name'])); ?></option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </select>
                                            </div>
                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-3 col-md-12 mt-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input required  type="number" class="form-control" placeholder="Quantity" name="current_stock" value="<?php echo e(old('current_stock')); ?>">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-3 col-md-12 mt-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input required type="number" step="any" class="form-control" placeholder="Unit Price" name="unit_price" value="<?php echo e(old('unit_price')); ?>">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-3 col-md-12 mt-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" min="0"  step="any" class="form-control" placeholder="Discount" name="discount" value="<?php echo e(old('discount')); ?>">
                                                    </div>
                                                </div>
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-lg-12 col-md-12 mt-3">
                                            <div class="form-group">
                                                ...
                                                <textarea id="summernote" class="form-control summernote" placeholder="Write some text..." name="summary"><?php echo e(old('summary')); ?></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-12 col-md-12 mt-3">
                                            <div class="form-group">
                                                ...
                                                <textarea id="description" class="form-control summernote" placeholder="Write some text..." name="description"><?php echo e(old('description')); ?></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-12 col-md-12 mt-3">
                                            <div class="form-group">
                                                ...
                                                <textarea id="features" class="form-control summernote" placeholder="Write some text..." name="features"><?php echo e(old('features')); ?></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-4 d-none"  id="shipping_div">
                                            <div class="col-6">
                                                ...
                                                <input type="text" class="form-control" name="processing_time" placeholder="4-5 days" value="<?php echo e(old('processing_time')); ?>">
                                            </div>
                                            <div class="col-6">
                                                <label >Shipping Time </label>
                                                <input type="text" placeholder="7-10 days" class="form-control" name="shipping_time" value="<?php echo e(old('shipping_time')); ?>" >
                                            </div>
                                        </div>
                                    </div>
                                   <div class="row mb-4">
                                                       ...
                                                       <div class="col-2">
                                                           <a href="javascript:void(0)" data-target-id="f" id="thumb-image"  class="img-thumbnail button-image">
                                                               <div id="input-image-f" class="display-imput-image">
                                                                   <img src="<?php echo e(Helper::DefaultImage()); ?>">
                                                               </div>
                                                           </a>
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-lg-6 col-md-12 ">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="meta_title" placeholder="Meta Title" class="form-control" value="<?php echo e(old('meta_title')); ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6 col-md-12 ">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="meta_keywords" placeholder="Meta Keywords" class="form-control" value="<?php echo e(old('meta_keywords')); ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-12 col-md-12 ">
                                            <div class="form-group">
                                                ...
                                                <textarea name="meta_description" class="form-control" placeholder="Write meta description..." id="" rows="4"><?php echo e(old('meta_description')); ?></textarea>
                                            </div>
                                        </div>
...
<?php $__env->startPush('scripts'); ?>
    ...
    <script>
        ...
        function get_attributes_values(e){
            $.ajax({
                url:"<?php echo e(route('product.get_attribute.values')); ?>",
                type:"POST",
                data:{
                    attribute_id:$(e).val(),
    ...
    <script>
        ...
        function update_sku() {
            ...
            $.ajax({
                type: "POST",
                url: '<?php echo e(route('product.sku-combination')); ?>',
                data: $('#choice_form').serialize(),
                success: function (data) {
...
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hpsystem/project/project-code/resources/views/backend/product/create.blade.php ENDPATH**/ ?>