                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-9 mx-auto mt-3">
                            <img src="<?php echo e(asset('frontend/assets/images/404.svg')); ?>" alt="error 404" width="609" height="131" style="height: 300px">
                            ...
                            <a href="<?php echo e(route('home')); ?>" class="btn btn-home mb-4">Go home</a>
                        </div>
                    </div>
                </div>
            </section>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/hpsystem/project/project-code/resources/views/errors/404.blade.php ENDPATH**/ ?>